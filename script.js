document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
        {
            question: "¿En qué isla se desarrolla la lectura?",
            answers: [
                "Puerto Rico",
                "Hawaii",
                "Sri Lanka",
        ...
        },
        {
            ...
            answers: [
                "El relato de la tradición de la ceremonia en Sri Lanka del corte del agua",
                "La vivencia de un niño con la leyenda del agua y la espada",
                "La importancia del agua en Sri Lanka",
                "La leyenda antigua de la bendición del agua"
            ],
            correctAnswer: "El relato de la tradición de la ceremonia en Sri Lanka del corte del agua"
        },
        {
            question: "¿Qué llevan los monjes hacia el río aparte de la espada?",
            answers: [
                "Cuatro vasijas de barro",
                "Una vasija de barro",
                "Cuatro vasijas de metal",
                "Una bandera y cuatro platones de plástico"
            ],
            correctAnswer: "Cuatro vasijas de metal"
        },
        {
            question: "¿Cuál es el mensaje principal de la lectura?",
            answers: [
                "Que el agua es un líquido muy preciado para todos",
                "Que el agua no se debe tomar como algo eterno y que es propiedad de todos",
                "Que con el agua no se debe jugar",
                "Que el agua es saludable"
            ],
            correctAnswer: "Que el agua no se debe tomar como algo eterno y que es propiedad de todos"
        },
        {
            question: "¿Qué se hace con las vasijas de metal al terminar la ceremonia?",
            answers: [
                "Se lanzan al río",
                "Se llenan con el agua del río y se regresan al templo",
                "Se devuelven a la tienda del monje",
                "Se dejan junto con la espada en el río"
            ],
            correctAnswer: "Se llenan con el agua del río y se regresan al templo"
        }
    ];
